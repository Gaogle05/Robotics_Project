...
def main2():
    ...
    startx, starty, goalx, goaly = 0,0,1,1 #gazebo co-ords
    s_x, s_y, g_x, g_y = 325,170,326,171 #code co-ords
    ...
    g_x, g_y = coordTransform_GazToMap(5, 5)
    waypoints = to_main(325,175,300,150)
    
    print(waypoints)
    
    #waypoints = [[1,1]]
    waypoints = coordTransform_MapToGaz(waypoints)
    print("transforming")
    print(waypoints)
...
def main():
    ...
    print("Gazebo coords: ",transposed_path)
